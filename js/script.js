	...
	$(function(){
		$(window).scroll(function(){
			...
			if($(this).scrollTop()>=300){
				...
				$('.navbar-default').css({'background-color' : '#185a9d'}).fadeIn('slow');
				$('.navbar-brand img').css({'height' : '75%' , '-webkit-transition' : '0.5s', 'transition' : '0.5s'});
				...
				$('.navbar-brand img').css({'height' : '85%'});
